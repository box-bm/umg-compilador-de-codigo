...
const tokenTable = {
  "let": { type: "Keyword", value: "let", regex: /let/ },
  "const": { type: "Keyword", value: "const", regex: /const/ },
  "if": { type: "Keyword", value: "if", regex: /if/ },
  "else": { type: "Keyword", value: "else", regex: /else/ },
  "for": { type: "Keyword", value: "for", regex: /for/ },
  "while": { type: "Keyword", value: "while", regex: /while/ },
  "do": { type: "Keyword", value: "do", regex: /do/ },
  "switch": { type: "Keyword", value: "switch", regex: /switch/ },
  "case": { type: "Keyword", value: "case", regex: /case/ },
  "id": { type: "Identifier", value: "id", regex: /[a-zA-Z_][a-zA-Z0-9_]*/ },
  "colon": { type: "Punctuation", value: ":", regex: /:/ },
  "type": { type: "Keyword", value: "type", regex: /type/ },
  "operator": { type: "Operator", value: "operator", regex: /[+\-*\/=<>!]/ },
  "boolean": { type: "Boolean", value: "boolean", regex: /true|false/ },
  "semicolon": { type: "Punctuation", value: ";", regex: /;/ },
  "string": { type: "string", regex: /^'[^']*'$/ },
  "number": { type: "number", regex: /^\d+$/ },
  "brace": { type: "brace", regex: /[\{\}]/ },
  "bracket": { type: "bracket", regex: /[\[\]]/ },
  "comma": { type: "comma", regex: /,/ },
};
